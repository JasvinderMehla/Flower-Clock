...
class _ColorLoader3State extends State<ColorLoader3>
  ...
  void initState() {
    ...
    controller = AnimationController(
        lowerBound: 0.0,
        upperBound: 1.0,
        duration: const Duration(milliseconds: 10050),
        vsync: this);
    ...
    animation_radius_in = Tween(begin: 1.0, end: 0.0).animate(
      CurvedAnimation(
        parent: controller,
        curve: Interval(0.77, 1.0, curve: Curves.easeInCirc),
      ),
    );
